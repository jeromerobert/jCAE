...
##################################################
#
# Environment variable $JAVA_HOME must be set before
# running this script, like 
...
export jythonPath=$rootDir/$(find jython/ -iname jython.jar)
export trovePath=$rootDir/$(find trove/ -iname trove.jar)
export vecmathPath=$rootDir/$(find vecmath/ -iname vecmath.jar)
export vtkPath=$rootDir/$(find vtkBuild/ -iname vtk.jar)
...
echo "path.occ.linux=$rootDir/oceBuild/" >> jcae.config
echo "path.jython.linux=$rootDir/jython/" >> jcae.config
echo "vtk.dir.linux=$rootDir/vtkBuild/" >> jcae.config
echo "path.occjava.linux=$rootDir/occjavaBuild/libOccJava.so" >> jcae.config
echo "libs.trove.classpath=$rootDir/trove/usr/share/java/trove.jar" >> jcae.config
echo "libs.VTK.classpath=$rootDir/vtkBuild/lib/vtk-5.6/java/vtk.jar" >> jcae.config
echo "libs.vecmath.classpath=$rootDir/vecmath/usr/share/java/vecmath.jar" >> jcae.config

export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$rootDir/oceBuild/lib/
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$rootDir/vtkBuild/lib/vtk-5.6/
...
ant config
ant clean
ant -Dnbplatform.default.netbeans.dest.dir="$rootDir/nb/" -Dnbplatform.default.harness.dir="$rootDir/nb/harness/"  
...
ant -Dnbplatform.default.netbeans.dest.dir="$rootDir/nb/" -Dnbplatform.default.harness.dir="$rootDir/nb/harness/" jar
...
cat ../../jcae.config >> nbproject/private/private.properties
java org.apache.xalan.xslt.Process -IN ./nbproject/project.xml -XSL ../../xsls/project-build-impl.xsl -OUT ./nbproject/build-impl.xml
ant -Dnbplatform.default.netbeans.dest.dir="$rootDir/nb/" -Dnbplatform.default.harness.dir="$rootDir/nb/harness/" -f nbbuild.xml jar
...
ant -Dnbplatform.default.netbeans.dest.dir="$rootDir/nb/" -Dnbplatform.default.harness.dir="$rootDir/nb/harness/" build-zip
cd $rootDir
