...
public class PrefProperty extends PropertySupport.Reflection {
    ...
    public PrefProperty(String prefName, String name, Object defValue, String description, Class moduleClass) throws NoSuchMethodException
    {
    ...
    public PrefProperty(String prefName, String name, Object defValue, Class moduleClass) throws NoSuchMethodException
    {
    ...
    public Object getValue()  {      
        ...
        {            
            ...
            String metName = prefName.replaceFirst( String.valueOf(firstChar) , String.valueOf(firstChar).toUpperCase());
        ...
        if(Double.class.isAssignableFrom(getValueType()))
            ...
            return (boolean) preferences.getBoolean(jCAEPrefName, (Boolean)retobj);
            ...
            return preferences.getInt(jCAEPrefName, Integer.parseInt((retobj.toString())));
    ...
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException
    {
        if(val.getClass().isAssignableFrom(String[].class ))
        {
            ...
            {
                preferences.put(jCAEPrefName+"."+i, ((String[])val)[i].toString() );
            }
        }
        else
