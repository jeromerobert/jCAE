...
public final class JCAEPanel extends PropertySheet {
    ...
    {
        try {
            PrefProperty p = new PrefProperty(prefName, prefName, this, moduleClass);
            return p.getValue();
    ...
    private Sheet.Set[] createPropertySet()
    {
            ...
            try {
                    PrefProperty p1 = new PrefProperty("MaximumMemory", "MaximumMemory", this, String.class);
                    r[0].put(p1);
                    
                    PrefProperty p2 = new PrefProperty("CustomJVMParameters", "CustomJVMParameters", this, String[].class);
                    r[0].put(p2);
                    
                    PrefProperty p3 = new PrefProperty("CustomMesherParameters", "CustomMesherParameters", this, String[].class);
                    r[0].put(p3);
                    
                    PrefProperty p4 = new PrefProperty("RunInSameJVM", "RunInSameJVM", this, boolean.class);
                    r[0].put(p4);
                    
                    PrefProperty p = new PrefProperty("CommandLineAlgo", "CommandLineAlgo", this, String[].class);
                    r[0].put(p);
            ...
            try {
                    PrefProperty p1 = new PrefProperty("PolygonOffset", "PolygonOffset", this, Double.class);
                    r[1].put(p1);
                    
                    PrefProperty p2 = new PrefProperty("PolygonOffsetFactor", "PolygonOffsetFactor", this,  Double.class);
                    r[1].put(p2);
            ...
            try {
                    PrefProperty p1 = new PrefProperty("AmibeARThreshold", "AmibeARThreshold", this, int.class);
                    r[2].put(p1);
    ...
    {
            ArrayList<String> toReturn=new ArrayList<String>();
            toReturn.add("-Xmx"+getOption("MaximumMemory", String.class).toString());
            String logPath = InstalledFileLocator.getDefault().
                    locate("etc/logging.properties", "org.jcae.netbeans.mesh", false).
                    getAbsolutePath();
            toReturn.add("-Djava.util.logging.config.file="+logPath);
            toReturn.addAll(Arrays.asList( (String[])  getOption("CustomJVMParameters", String[].class)));
            return toReturn;
    }
