...
public class BoundingPolytope extends Bounds {
	...
	if (planes.length < 4) {
	    throw new IllegalArgumentException("BoundingPolytope11");
	}
	...
	if( boundsObject.boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(("BoundingPolytope0"));
	}
    }
	...
	if( boundsObjects[i].boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(("BoundingPolytope1"));
	}
	...
	if( boundsObject == null )  {
	    ...
	    throw new IllegalArgumentException(("BoundingPolytope2"));
	}
	...
	if( boundsObject.boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(("BoundingPolytope3"));
	}
	...
	for(;i<boundsObjects.length;i++) {
		...
		throw new IllegalArgumentException(("BoundingPolytope4"));
	    }
	...
	if( boundsObject.boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(("BoundingPolytope5"));
	}
    }
	...
	if( boundsObject.boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(("BoundingPolytope6"));
	}
    }
	...
	for(i = 0; i < boundsObjects.length; i++){
		...
		throw new IllegalArgumentException(("BoundingPolytope7"));
	    }
	}
	...
	if( boundsObject.boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(("BoundingPolytope8"));
	}
	...
	for(i = 0; i < boundsObjects.length; i++){
		...
		if( boundsObjects[i] instanceof BoundingSphere ) {
		    ...
		    throw new IllegalArgumentException(("BoundingPolytope10"));
		}
	    }
	}
