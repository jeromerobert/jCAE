...
public class BoundingBox extends Bounds {
    ...
    private final Point3d tmpP3d = new Point3d();
	...
	if( boundsObject == null ) {
	    ...
	    throw new IllegalArgumentException("BoundingBox0");
	}
    ...
    public BoundingBox(Bounds[] bounds) {
      int i=0;
       ...
       for(;i<bounds.length;i++) {
	       ...
	       throw new IllegalArgumentException("BoundingBox1");
	   }
       }
       updateBoundsStates();
    }
	...
	if( boundsObject.boundId == BOUNDING_BOX){
	    ...
	    throw new IllegalArgumentException("BoundingBox3");
	}
	...
	public void combine(Bounds[] bounds) {
       ...
       for(;i<bounds.length;i++) {
	      ...
	      throw new IllegalArgumentException("BoundingBox4");
 	  }
       }
	...
	if(boundsObject.boundId == BOUNDING_BOX){
	    ...
	    throw new IllegalArgumentException("BoundingBox5");
	}
    }
   ...
   boolean intersect(Bounds boundsObject, Point4d position) {
	...
	if( boundsObject.boundId == BOUNDING_BOX){
	    ...
	    return intersect_ptope_abox ( (BoundingPolytope)boundsObject, this );
            ...
            throw new IllegalArgumentException("BoundingBox6");    
        }    
	...
	if(boundsIsInfinite && (!boundsObject.boundsIsInfinite)) {
		...
		return false;
            ...
            throw new IllegalArgumentException("BoundingBox7");    
        }    
    }
	...
	for(i = 0; i < boundsObjects.length; i++){
		...
		if( boundsObjects[i].boundId == BOUNDING_BOX){
		    ...
		    throw new IllegalArgumentException("BoundingBox9");    
		}
	    }
	}
