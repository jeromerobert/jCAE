...
public class BoundingSphere extends Bounds {
	...
	if (boundsObject == null) { 
	    ...
	    throw new IllegalArgumentException(("BoundingSphere0"));
	}
	...
	if ((boundsObject == null) || boundsObject.boundsIsEmpty) {
	    ...
	    throw new IllegalArgumentException(("BoundingSphere2"));
	}
	updateBoundsStates();
    }
	...
	if( boundsObject.boundId == BOUNDING_BOX){
	    ...
	    throw new IllegalArgumentException(("BoundingSphere3"));
	}
	updateBoundsStates();
    }
	...
	for(;i<boundsObjects.length;i++) {
		...
		throw new IllegalArgumentException(("BoundingSphere4"));
	    }
	}
	...
	if( boundsObject.boundId == BOUNDING_BOX){
	    ...
	    throw new IllegalArgumentException(("BoundingSphere5"));
	}
    }
	...
	if( boundsObject.boundId == BOUNDING_BOX){
	    ...
	    throw new IllegalArgumentException(("BoundingSphere6"));
	}
    }
	...
	for(i = 0; i < boundsObjects.length; i++){
		...
		throw new IllegalArgumentException(("BoundingSphere7"));
	    }
	}
	...
	if(boundsIsInfinite && (!boundsObject.boundsIsInfinite)) {
	    ...
	    throw new IllegalArgumentException(("BoundingSphere8"));
	}
    }
	...
	for(i=0;i<boundsObjects.length;i++) {
		...
		throw new IllegalArgumentException(("BoundingSphere9"));
	    }
	}
	if( status  == false) {
	    // Negative volume.
	...
	for(i = 0; i < boundsObjects.length; i++){
		...
		if(boundsObjects[i].boundId == BOUNDING_BOX){
		    ...
		    throw new IllegalArgumentException(("BoundingSphere10"));
		}
	    }
	}
