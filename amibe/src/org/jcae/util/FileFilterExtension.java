...
public class FileFilterExtension extends FileFilter {
     ...
     * Example: new FileFilterExtension("jpg");
     *
     * @see #addExtension
     */
     ...
     * Example: new FileFilterExtension("jpg", "JPEG Image Images");
     *
     ...
     * Example: new FileFilterExtension(String {"gif", "jpg"});
     *
     ...
     * @see #addExtension
     */
    public FileFilterExtension(String[] filters) {
	this(filters, null);
    }

    /**
     * Creates a file filter from the given string array and description.
     * Example: new FileFilterExtension(String {"gif", "jpg"}, "Gif and JPG Images");
     *
     * Note that the "." before the extension is not needed and will be ignored.
     *
     * @see #addExtension
     */
    public FileFilterExtension(String[] filters, String description) {
	this();
