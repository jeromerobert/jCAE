...
public class Bora1DReader
{
	private static Logger logger=Logger.getLogger(Bora1DReader.class);
	 ...
	 */
	public static MMesh1D readObject(Mesh mesh, String xmlFile)
	{
		MMesh1D m1d = null;
		String xmlDir = mesh.getOutputDir();
		int i;
