...
public abstract class MeshProcessorGUI extends JDialog
{	
	private MeshObject meshObject;
	private MeshModule meshModule;
	
	public MeshProcessorGUI()
	{
	...
	protected MeshObject getMeshObject()
	{
		return meshObject;
	}	
	
	protected MeshModule getMeshModule()
	{
		return this.meshModule;
	}
