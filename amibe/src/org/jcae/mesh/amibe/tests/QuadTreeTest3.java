...
public class QuadTreeTest3 extends QuadTreeTest
{
	private static Logger logger=Logger.getLogger(QuadTreeTest3.class);	
	
	//  Dummy constructor
	public QuadTreeTest3(double umin, double umax, double vmin, double vmax)
	{
