...
public class QuadTreeTest2 extends QuadTreeTest
{
	private static Logger logger=Logger.getLogger(QuadTreeTest2.class);	
	
	//  Dummy constructor
	public QuadTreeTest2(double umin, double umax, double vmin, double vmax)
	{
