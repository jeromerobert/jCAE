...
/**
 * This class MesherBig allows to load a file, construct the mesh structure and read mesh hypothesis.
 ...
 */
public class MesherBig
{
	private static Logger logger=Logger.getLogger(MesherBig.class);
