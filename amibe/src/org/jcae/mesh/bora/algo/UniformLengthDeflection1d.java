...
// This class should probably be renamed; AlgoMesh1d could be the new name
/**
...
public class UniformLengthDeflection1d
{
	...
	/**
	 * Creates a <code>UniformLengthDeflection1d</code> instance.
	 *
	 * @param m  the <code>MMesh1D</code> instance to mesh.
	 */
	public UniformLengthDeflection1d(MMesh1D m)
	{
		mesh1d = m;
