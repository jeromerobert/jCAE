 ...
 * @author jerome
 */
public class SmoothParametersBeanInfo extends SimpleBeanInfo
{
    ...
    private static final int PROPERTY_elementSize = 0;
    private static final int PROPERTY_iterationNumber = 1;
